...
# axiom-exec first because it is the bigger and quieter of the two, santhserver
...
: "${HARNESS_ENDPOINTS:=axiomexec axiomexec@192.168.0.135 santhserver santh@192.168.0.161}"
